      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium text-neutral-700">
            ...
            <Link href="/search?sale=true" className="text-rose-600 font-semibold hover:text-rose-700">{t.sale}</Link>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="inline-flex items-center rounded-full border border-neutral-200 bg-neutral-50 p-0.5 text-xs font-semibold">
              <button
                type="button"
            ...
            <Link href="/account" title={t.account} className="text-neutral-700 hover:text-neutral-900 p-1">
              <User className="w-5 h-5" />
            </Link>

            <Link href="/cart" title={t.cart} className="relative text-neutral-700 hover:text-neutral-900 p-1">
